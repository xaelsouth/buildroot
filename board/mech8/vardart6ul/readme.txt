*******************************
mech8 vardart6ul mmc wifi board
*******************************

Build
=====

First, configure Buildroot for your mech8 board:

In order to to do so there are two supported options:

  $ make mech8_vardart6ul_mmc_wifi_defconfig

if you plan to use a board with eMMC and eMMC.
